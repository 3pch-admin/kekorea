...
public class ApprovalHelper implements MessageHelper {
	...
	public static final String LINE_AGREE_COMPLETE = "검토완료";
	public static final String LINE_RETURN_COMPLETE = "반려됨";
	public static final String LINE_STAND = "대기중";
	public static final String LINE_AGREE_STAND = "검토중";
	public static final String LINE_RECEIVE_STAND = "수신확인중";
	public static final String LINE_RECEIVE_COMPLETE = "수신완료";
	public static final String LINE_AGREE_REJECT = "검토반려";
