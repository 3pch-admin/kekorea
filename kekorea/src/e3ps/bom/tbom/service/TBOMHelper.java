...
public class TBOMHelper {
	...
	public Map<String, Object> list(Map<String, Object> params) throws Exception {
		...
		QuerySpecUtils.toLikeAnd(query, idx, TBOMMaster.class, TBOMMaster.NAME, name);
		QuerySpecUtils.toCreator(query, idx, TBOMMaster.class, creatorOid);
		QuerySpecUtils.toTimeGreaterAndLess(query, idx, TBOMMaster.class, TBOMMaster.CREATE_TIMESTAMP, createdFrom,
				createdTo);
		...
		while (result.hasMoreElements()) {
			...
			int _idx = _query.appendClassList(TBOMMaster.class, true);
			int _idx_p = _query.appendClassList(Project.class, true);
			int _idx_link = _query.appendClassList(TBOMMasterProjectLink.class, true);

			QuerySpecUtils.toEqualsAnd(_query, _idx_link, TBOMMasterProjectLink.class, "roleAObjectRef.key.id", master);
			QuerySpecUtils.toInnerJoin(_query, TBOMMaster.class, TBOMMasterProjectLink.class,
					WTAttributeNameIfc.ID_NAME, "roleAObjectRef.key.id", _idx, _idx_link);
			QuerySpecUtils.toInnerJoin(_query, Project.class, TBOMMasterProjectLink.class, WTAttributeNameIfc.ID_NAME,
