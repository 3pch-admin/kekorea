...
public class YCodeLoader {
	...
	public static void main(String[] args) throws Exception {
		...
		YCodeLoader loader = new YCodeLoader();
	...
	private void loadYCodeInfo(HashMap<String, Object> map) throws Exception {
		LoadHelper.service.setYCode(map);
	}
}
