...
// 	}
	// module
	String module = ModuleKeys.list_library_part.name();
...
// 		grid.gridImgStart();
		...
		grid.cellClickSmallPopup("spec", url);
		grid.cellClickSmallPopup("number", url);
	
		$.fn.getColumn = function() {
			var url = "/Windchill/plm/part/listLibraryPartAction";
...
<%-- 				grid.getImgData(data, headers, "<%=isBox%>", false, url); --%>
	...
	<div class="header_title">
		<i class="axi axi-subtitles"></i><span>라이브러리 조회</span>
		<!-- info search -->
