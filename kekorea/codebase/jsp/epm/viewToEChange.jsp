...
<td valign="top"><script type="text/javascript">
			...
			<td class="left">
				<div class="AXTabs">
					<div class="AXTabsTray">
						<a class="AXTab epmView" title="<%=titleText%>정보"><%=titleText%>정보</a> <a class="AXTab viewToEChange on" title="설계변경 정보">설계변경 정보</a>
						<%
							if (is2D) {
						%>
						<a class="AXTab viewToImage" title="이미지 파일">이미지 파일</a>
						<%
							}
						%>
 ...
 %>
	<div class="AXTabs">
		<div class="AXTabsTray">
			<a class="AXTab epmView" title="<%=titleText%>정보"><%=titleText%>정보</a> <a class="AXTab on viewToEChange on" title="설계변경 정보">설계변경 정보</a>
			<%
				if (is2D) {
			%>
			<a class="AXTab viewToImage" title="이미지 파일">이미지 파일</a>
