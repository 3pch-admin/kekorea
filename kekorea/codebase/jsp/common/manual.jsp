...
// 		$("input").checks();
	...
	<div class="header_title">
		<i class="axi axi-subtitles"></i><span>메뉴얼</span>
		<!-- info search -->
	...
	<table class="search_table">
		<tr>
			...
			<th>파일양식</th>
			<td><input type="text" class="AXInput wid150" name="fileType" id="fileType" value="<%=fileType != null ? fileType : ""%>"> <i title="삭제 (D)"
				class="axi axi-ion-close-circled delete-text" data-target="fileType"></i></td>
		</tr>
	</table>
			...
			<tbody>
				<%
					for (int i = 0; i < list.size(); i++) {
						...
						String url = "/Windchill/jsp/common/manual/" + f.getName();
				%>
				<tr>
