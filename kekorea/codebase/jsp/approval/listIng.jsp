...
<%
	...
	// module
	String module = ModuleKeys.list_ing.name();
...
// 	String[] styles = ColumnUtils.getColumnStyles(module, headers);
	...
	String[] styles = new String[]{"40", "300", "600", "100" };
%>
<td valign="top">
	<!-- script area --> 
	...
	$(document).ready(function() {
		...
		$.fn.getColumn = function() {
			var url = "/Windchill/plm/approval/listIngAction";
	...
	<div class="header_title">
		<i class="axi axi-subtitles"></i><span>진행함</span>
		<!-- info search -->
