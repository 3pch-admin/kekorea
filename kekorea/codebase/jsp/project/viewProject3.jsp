			...
			<td id="container_td">
				<table class="project_table">
					<tr>
						...
						<th rowspan="2" class="border-left min-wid50">진행률/적정</th>
						<td rowspan="2" class="center min-wid50 border-top-blue "><%=data.kekProgress %>%/<%=data.comp%>%</td>
					</tr>
					...
					<tr>
						...
						<td class="indent10" colspan="4"><%=data.description %></td>
				...
				<table class="project_table">
					...
					<tr>
						<td class="center"><%=data.duration %>[<%=data.holiday %>]일</td>
