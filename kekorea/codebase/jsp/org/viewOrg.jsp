...
// 		view url
		...
		<%if(CommonUtils.isAdmin()){%>
 		...
 		grid.cellClickSmallPopup("id", url);
 		<%}%>
	...
	<div class="header_title">
		<i class="axi axi-subtitles"></i><span>조직도</span>
		<!-- info search -->
					...
					<tr>
						<td>
							...
							<div class="non_paging_layer">
								...
								<label title="하위부서검색"> 
									<input name="sub_folder" id="sub_folder" type="checkbox" value="ok" checked="checked">하위부서검색
								</label>
								</span>
