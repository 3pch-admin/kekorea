					...
					<tr>
						<td class="topPadding"><img src="/Windchill/jsp/images/title_bullet.gif"> <span class="left_title">작업공간</span>
							<ul class="left_menu_ul">
								<li><span class="left_title listAgree" data-url="/approval/listAgree" title="검토함 (<%=count[0]%>건)">▪&nbsp;검토함&nbsp;<span class="vsp">(</span><%=count[0]%>건<span class="vsp">)</span></span></li>
								<li><span class="left_title listApproval" data-url="/approval/listApproval" title="결재함 (<%=count[1]%>건)">▪&nbsp;결재함&nbsp;<span class="vsp">(</span><%=count[1]%>건<span class="vsp">)</span></span></li>
