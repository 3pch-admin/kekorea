...
<td valign="top"><script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on("dblclick", "#userLineList option", function() {
			...
			<tr>
				...
				<td>
					...
					<table class="line_btn_table">
						...
						<tr>
							<td class="border_none pad-5"><input type="button" title="개인결재선 삭제" value="개인결재선 삭제" id="deleteLineBtn" class="redBtn"></td>
						</tr>
						<tr>
