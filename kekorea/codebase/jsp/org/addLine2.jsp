...
// 		alert(keyCode);
	...
	<table class="btn_table top_margin0">
		<tr>
			...
			<td class="right">
			<input type="button" value="적용" title="적용" id="applyLineBtn" class=""> <input type="button" value="닫기" title="닫기 (C)" id="closeBtn" onclick="self.close();" class="redBtn"></td>
		</tr>
	</table>
			...
			<tr>
				...
				<td>
					<table class="type_table">
						...
						<tr>
							<td><label title="합의"><input value="agree" name="appType" type="radio">합의</label></td>
						</tr>
						<tr>
							<td><label title="수신"><input value="receive" name="appType" type="radio">수신</label></td>
						</tr>
						<tr>
							<td class="border_none pad-5 org_btn"><input type="button" title="추가" value="추가" id="addOrgLineBtn"> <input type="button" title="삭제 (D)" value="삭제 (D)" id="deleteLine"
								class="redBtn"></td>
							<td class="border_none pad-5 line_btn none"><input type="button" title="추가" value="추가" id="addLineBtn"> <input type="button" title="삭제 (D)" value="삭제 (D)" id="deleteLines"
								class="redBtn"></td>
						</tr>
						<tr>
					...
					<table class="line_btn_table">
						...
						<tr>
							<td class="border_none pad-5"><input type="button" title="삭제 (D)" value="삭제 (D)" id="deleteLineBtn" class="redBtn"></td>
						</tr>
						<tr>
				...
				<td valign="top">
					...
					<table class="app_layer_table">
						<tr>
							<td>
								<div class="header_title">
									<i class="axi axi-subtitles"></i><span>합의라인</span>
								</div>
							</td>
						</tr>
						<tr>
									...
									<table class="line_table_in" id="agree_table">
										...
										<tbody id="agreeBody">
											<tr id="nodataTr_agree">
												<td class="app_nodata_icon" colspan="5"><a class="axi axi-info-outline"></a> <span>지정된 합의라인이 없습니다.</span></td>
											</tr>
										</tbody>
									</table>
								</div>
