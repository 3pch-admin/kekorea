...
<%
	...
	String[] headers = {"PART_NO", "PART_NAME", "PART_SPEC","USERID", "작성일", "FLAG", "INTERFACE_DATE", "RESULT"};
	
	System.out.println("headers 이름 : " + headers.toString());
	
	// table header key
	String[] keys = {"PART_NO", "PART_NAME", "PART_SPEC","USERID", "CREATE_TIME", "FLAG", "INTERFACE_DATE", "RESULT"};
	// table cols
	String[] cols = {"PART_NO", "PART_NAME", "PART_SPEC","USERID", "CREATE_TIME", "FLAG", "INTERFACE_DATE", "RESULT"};
	// table style
// 	String[] styles = ColumnUtils.getColumnStyles(module, headers);
	
	String[] styles = new String[]{"40", "40", "40","40", "40", "40", "40", "40"};
...
<td valign="top">
	...
	$(document).ready(function() {
		...
		$.fn.getColumn = function() {
			...
			var url = "/Windchill/plm/admin/searchErpPartAction";
			...
			<td id="container_td">
				...
				<table class="search_table">
					...
					<tr>
						<th>PART_SPEC</th>
						<td>
							<input type="text" name="partSpec" id="partSpec" class="AXInput wid200">
						</td>
						<th>전송일</th>
						<td>
