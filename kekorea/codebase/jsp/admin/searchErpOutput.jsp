...
<%
	...
	String[] headers = {"기준번호", "작번내부코드", "표준산출물코드","USERID", "작성일", "FLAG", "INTERFACE_DATE", "RESULT"};
	
	System.out.println("headers 이름 : " + headers.toString());
	
	// table header key
	String[] keys = {"STDNO", "PJTSEQ", "STDREPORTSEQ","USERID", "CREATE_TIME", "FLAG", "INTERFACE_DATE", "RESULT"};
	// table cols
	String[] cols = {"STDNO", "PJTSEQ", "STDREPORTSEQ","USERID", "CREATE_TIME", "FLAG", "INTERFACE_DATE", "RESULT"};
	// table style
...
<td valign="top">
	...
	$(document).ready(function() {
		...
		$.fn.getColumn = function() {
			...
			var url = "/Windchill/plm/admin/searchErpOutputAction";
