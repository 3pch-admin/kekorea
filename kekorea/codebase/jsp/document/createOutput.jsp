...
// 		$(".fix_table").tableHeadFixer();
	...
	<tr>
		<td>
				...
				<i class="axi axi-subtitles"></i><span>산출물 등록</span>
				<!-- req msg -->
			...
			<td class="right">
				<input type="button" value="저장" id="createOutputAction" title="저장" data-self="false" data-output="<%=isOutput %>" 
				data-toid="<%=toid %>"
				data-progress="<%=progress %>" data-ptype="<%=ptype %>">
...
<!-- 				<input type="button" value="취소" id="backBtn" title="취소" class="redBtn"> -->
	...
	<table class="create_table">
		...
		%>
		<tr>
			<th><font class="req">산출물 제목</font></th>
			<td>
		...
		%>
		<tr>
			<th><font class="req">KEK 작번<br>( <span id="descProjectCnt">0</span>&nbsp;개 )</font></th>
			<td colspan="3">
