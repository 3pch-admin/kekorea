...
<%
	...
	if("SPEC".equals(location)) {
		root = DocumentHelper.SPEC;
	} else if ("OLDSPEC".equals(location)){
		root = DocumentHelper.OLDSPEC;
// 		module = ModuleKeys.add_old_output.name();
	}
...
<td valign="top">
	...
	$(document).ready(function() {
		...
		<%
			if("SPEC".equals(location)) {
		%>
		var url = "/Windchill/plm/document/listDocumentSpecAction";
		<%
			} else if("OLDSPEC".equals(location)){
		%>
		var url = "/Windchill/plm/document/listDocumentOldSpecAction";
		<%
			} else {
		%>
