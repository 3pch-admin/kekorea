				...
				return [ {
					...
					renderer : {
						...
						jsCallback : function(rowIndex, columnIndex, value, item) {
							const oid = item.oid;
							const url = getCallUrl("/workspace/view?oid=" + oid + "&columnType=COLUMN_AGREE&poid=e3ps.bom.partlist.PartListMaster:95021123");
							popup(url, 1400, 700);
						}
					},
					filter : {
					...
					renderer : {
						...
						jsCallback : function(rowIndex, columnIndex, value, item) {
							const oid = item.oid;
							const url = getCallUrl("/workspace/view?oid=" + oid + "&columnType=COLUMN_AGREE&poid=" + item.poid);
							popup(url, 1400, 700);
						}
					},
					filter : {
